                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('fistname') ? ' has-error' : '' }}">
                            <label for="fistname" class="col-md-4 control-label">fistname</label>

                            <div class="col-md-6">
                                <input id="fistname" type="text" class="form-control" name="fistname" value="{{ old('fistname') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('userState') ? ' has-error' : '' }}">
                            <label for="userState" class="col-md-4 control-label">userState</label>
